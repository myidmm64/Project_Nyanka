...
public class PlayerAnimationEvent_Suzuka_Skill : PlayerAnimationEvent
{
    ...
    public override void AttackAnimation(int id)
    {
        ...
        {
            case 0:
                PopupUtility.DialogText(transform.position + Vector3.right * 2f + Vector3.up * 1.5f, ImageManager.Instance.GetImageData(ElementType.Water).color, "ÇÑ±â ¼Ó¿¡ ¸öÀ» ¼û±â°í", 0.8f, "ÇÑ·©ÆÄ", 0.5f);
