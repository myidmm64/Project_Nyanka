...
public class Arrow : MonoBehaviour
{
    ...
    public void ArrowInit(float speed, Vector3 position, Quaternion rot, List<Vector3Int> boomVectors, int penetrateCount, float lifeTime, int dmg, ElementType type, bool critical, bool isPlayer)
    {
        _speed = speed;
