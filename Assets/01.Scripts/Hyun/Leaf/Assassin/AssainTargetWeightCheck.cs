...
public class AssainTargetWeightCheck : Node
{
    AIMainModule _aIMainModule;

    public AssainTargetWeightCheck(AIMainModule aIMainModule)
    {
    ...
    public override NodeState Evaluate()
    {
        ...
        _aIMainModule.cells.Keys.ToList().ForEach(key =>
        {
            ...
            _aIMainModule.cells[key] += (tempX > tempZ) ? tempX * 20 : tempZ * 20;
        });
